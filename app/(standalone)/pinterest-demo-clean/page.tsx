...
function PinterestDemoContent() {
  ...
  const startOAuth = () => {
    ...
    const authUrl = `https://www.pinterest.com/oauth/?client_id=${APP_ID}&redirect_uri=${encodeURIComponent(REDIRECT_URI)}&response_type=code&scope=${scopes}&state=clean_${Date.now()}`
...
export default function PinterestDemoClean() {
  return (
    <Suspense fallback={
