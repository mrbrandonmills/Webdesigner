...
export const metadata: Metadata = {
  title: 'The Harvard Classics: A Crimson Education Minus the Price Tag | Brandon Mills',
  ...
  keywords: ['philosophy', 'technology', 'harvard', 'classics', 'crimson', 'education', 'minus'],
  openGraph: {
    title: 'The Harvard Classics: A Crimson Education Minus the Price Tag',
    description: 'The Harvard Classics, also known as the “Five-Foot Shelf,” is a 51-volume series of classic literature that was first compiled by Harvard University President C...',
    type: 'article',
...
export default function BlogPost() {
  return (
    <main className="min-h-screen bg-black text-white">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <header className="mb-12">
            <div className="flex flex-wrap gap-2 mb-4">
              {['philosophy', 'technology', 'harvard', 'classics', 'crimson', 'education', 'minus'].slice(0, 3).map((tag) => (
            ...
            <h1 className="text-4xl md:text-5xl font-serif mb-6 leading-tight">
              The Harvard Classics: A Crimson Education Minus the Price Tag
            </h1>
          ...
          <footer className="mt-16 pt-8 border-t border-white/10">
            <div className="flex items-center justify-between">
              <div className="flex flex-wrap gap-2">
                {['philosophy', 'technology', 'harvard', 'classics', 'crimson', 'education', 'minus'].map((tag) => (
      ...
      <EbookCTA variant="footer" source="the-harvard-classics-a-crimson-education-minus-the-price-tag" />
</div>
      </article>
    </main>
  )
